...
class Registration extends CI_Controller {
	...
	{    
		...
		if($this->input->post()){  
			...
			if($this->form_validation->run() !== FALSE){
				...
				$option=['cost' => 10,'salt' => 'pratikkajarejhfjdhjhjhafkdfhhsdkhfhfjdhfjh'];

				$record['password'] =password_hash( $this->input->post('password'),PASSWORD_BCRYPT,$option); 
	...
	public function sign(){
		...
		// $con=mysqli_connect('localhost','root','','all');
